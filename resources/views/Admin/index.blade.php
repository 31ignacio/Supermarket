              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <td>
                    {{-- <a class="btn-sm btn-success" href="" title="Activer"><i class="fas fa-user-check"></i></a> --}}
                    {{-- <button type="button" class="btn-sm btn-danger" title="Désactiver" data-toggle="modal" data-target="#myModal" onclick="updateModalContent({{ $admin->id }})">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Confirmation de désactivation</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="{{route('admin.disable')}}" method="post">
                            @csrf
