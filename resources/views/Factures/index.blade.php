        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="{{ route ('facture.point')}}" class="btn  bg-gradient-success">Point de la journée</a><br><br>
                                    ...
                                    @foreach ($codesFacturesUniques as $factureUnique)
                                        ...
                                        {{-- {{dump(2)}} --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('facture.details', ['code' => $factureUnique->code, 'date' => $factureUnique->date]) }}"
                                                                class="btn-sm btn-primary col-sm-12">Détail</a>

                                                            @auth
                                                                @if (auth()->user()->role_id === 1)

                                                                    <a href="#" class="btn-sm btn-danger col-sm-12" data-toggle="modal"
                                                                        data-target="#confirmationModal"
                                                                        onclick="updateModal('{{ $factureUnique->code }}')">Annuler</a>
